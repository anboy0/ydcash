...
public enum CommonStatus implements RestStatus {
    ...
    DATA_EMPTY(601, "数据为空"),
    DUPLICATE_ENTRY(602, "重复数据"),
    PRINT_EMPTY(603, "打印请求数据为空"),
    PRINT_TYPE(604, "打印请求类型为空"),
    PRINT_TYPE_NOT_SUPPORT(605, "打印请求类型不支持"),
    PRINT_ERROR(606, "打印模板转换失败"),
    UNAMEORPWORD_NOTEXSIT(600, "原密码验证不正确"),
    SAVE_OK(200, "保存成功"),
    USER_NAME_REPEAT(500,"用户名重复"),
    ROLE_NAME_REPEAT(500,"角色名重复"),
    COMPANY_CODE_REPEAT(500,"公司代码重复"),
    LOGOUT_SUCCESS(200,"退出成功"),
    ROLE_HAVE_MENU(600,"该角色已分配权限"),
    SITE_CODE_REPEAT(500,"网点编号已存在"),
    SITE_NAME_REPEAT(500,"网点名称已存在"),
    SITE_NO_PARENT_REPEAT(501,"所属网点不存在"),
    
    REMARK_LENGTH(700, "备注长度不能超过100位字符，请重新输入。"),
    NAME_LENGTH15(701, "姓名只能输入1-15位字符，请重新输入。"),
    
    INTERNAL_ERROR(-1, "系统内部异常，请联系管理员。"),

    DELETE_FALSE(203, "请先删除子项目!!!"),
    AMOUNT_LIMIT(800,"合计收款金额小于等于100万"),
    //2.HttpStatus自带状态码
    // 1xx Informational
